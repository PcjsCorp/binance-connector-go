...
### NewQueryVIPLoanFixedRateMarketResponseRowsInner
...
### NewQueryVIPLoanFixedRateMarketResponseRowsInnerWithDefaults
...
GetRequestNo returns the RequestNo field if non-nil, zero value otherwise.

### GetRequestNoOk

`func (o *QueryVIPLoanFixedRateMarketResponseRowsInner) GetRequestNoOk() (*int64, bool)`

GetRequestNoOk returns a tuple with the RequestNo field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetRequestNo sets RequestNo field to given value.
...
GetEstimatedInterest returns the EstimatedInterest field if non-nil, zero value otherwise.

### GetEstimatedInterestOk

`func (o *QueryVIPLoanFixedRateMarketResponseRowsInner) GetEstimatedInterestOk() (*string, bool)`

GetEstimatedInterestOk returns a tuple with the EstimatedInterest field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetEstimatedInterest sets EstimatedInterest field to given value.
